<header>
    <div class="container">
      <div class="row">
        ...
        <div class="col-xs-10">
            ...
            <h2>Inscriptions et résultats</h2>
        </div>
        </div>
    </div>
    ...
    <div class="container">  
      <div class="navbar-header">   
        ...
        <a class="navbar-brand" href="site03.php">Concours Equitation</a>
      </div>
        ...
        <ul class="nav navbar-nav">
         ...
         <li class="dropdown"> 
            ...
            <ul class="dropdown-menu">
              ...
              <li><a href="https://ffecompet.ffe.com/concours">Liste compétitions FFE</a></li>
            </ul>
          </li>
          <li><a href="connection.php"><span class = "glyphicon glyphicon-user" ></span>  Connexion </a></li>
        </ul>
        </ul>
      </div>
    </nav>
